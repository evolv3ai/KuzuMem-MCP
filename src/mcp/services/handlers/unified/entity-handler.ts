  ...
  try {
    switch (operation) {
      case 'create': {
        ...
        // Call appropriate EntityService method based on entity type
        switch (entityType) {
          case 'component':
          ...
          case 'decision':
            ...
            break;
          case 'rule':
            await entityService.upsertRule(
              context,
              clientProjectRoot,
              repository,
              entityData as Rule,
      ...
      case 'get': {
        ...
        // Call appropriate EntityService get method based on entity type
        switch (entityType) {
          case 'component':
            entity = await entityService.getComponent(
              context,
              clientProjectRoot,
              repository,
              branch,
            ...
            break;
          case 'decision':
            entity = await entityService.getDecision(
              context,
              clientProjectRoot,
              repository,
              branch,
            ...
            break;
          case 'rule':
            entity = await entityService.getRule(
              context,
              clientProjectRoot,
              repository,
              branch,
            ...
            break;
          case 'file':
            entity = await entityService.getFile(
              context,
              clientProjectRoot,
              repository,
              branch,
            ...
            break;
          case 'tag':
            entity = await entityService.getTag(
              context,
              clientProjectRoot,
              repository,
              branch,
      ...
      case 'update': {
        ...
        // Call appropriate EntityService update method based on entity type
        switch (entityType) {
          case 'component':
            updatedEntity = await entityService.updateComponent(
              context,
              clientProjectRoot,
              repository,
              branch,
            ...
            break;
          case 'decision':
            updatedEntity = await entityService.updateDecision(
              context,
              clientProjectRoot,
              repository,
              branch,
            ...
            break;
          case 'rule':
            updatedEntity = await entityService.updateRule(
              context,
              clientProjectRoot,
              repository,
              branch,
      ...
      case 'delete': {
        ...
        // Call appropriate EntityService delete method based on entity type
        switch (entityType) {
          case 'component':
